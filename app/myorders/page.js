...
const page = () => {
    ...
    const fetchData = async () => {
        ...
        const respData = await axios.get(`/api/billing/${uid}`);
        console.log("reponse data", respData.data.resp); 
        if (respData.data.message == 'Successfull') {
        ...
        <>
            <Grid container>
                ...
                <Grid item xs={12} sx={{ display: "flex", justifyContent: "space-between", p: "15px 10px" }}>
                    ...
                    <Box>
                        <Typography>{orders.length} Active Orders</Typography>
                    </Box>

                    <Box>
                        <Button variant='contained' color='success' onClick={() => { router.push('/pastorder') }}>Past Orders</Button>
                    </Box>
                ...
                </Grid>
                {
                    ...
                    <Grid container justifyContent={"center"} alignItems={"center"}>
                        <Grid item xs={6} sx={{height:"40vh",display:"flex",alignItems:"center",justifyContent:"center"}}>
                           <Typography sx={{color:"#bdbdbd"}}>No Data Found</Typography>
                        </Grid>
                    </Grid>
                    :
                <Grid container justifyContent={"center"} alignItems={"center"}>
                                        ...
                                        >
                                            <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                                                <Typography sx={{ flexShrink: 0 }}>
                                                    Order ID: <span style={{fontSize:"14px"}}>#{ele._id}</span>
                                                </Typography>
