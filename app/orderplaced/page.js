...
import order from '../../assests/order2.gif'
...
const orderPlaced = () => {
  ...
  return (
    <>
    <MainHeader/>
    <Grid container sx={{justifyContent:"center",alignItems:"center",height:"85dvh"}}>
        <Grid item xs={11.5} sm={10} md={7} lg={5}>
            <Paper elevation={3} sx={{p:"10px",bgcolor:"#fbfbfb"}}>
                  <Box sx={{display:"flex",justifyContent:"center"}}>
                    <Box sx={{position:"relative"}}>
                        <Image src={order} alt='order' style={{height:"150px",width:"200px",borderRadius:"20px",overflow:"hidden"}}/>
                    </Box>
                    </Box>
                    <Box>
                        <Typography align='center' sx={{fontSize:"20px",color:"green"}}>Order Placed Successfully.</Typography>
                        <Typography align='center' sx={{fontSize:"16px",color:"#9e9e9e"}}>Order ID : <span style={{color:"black"}}>#2ds3dc33fvvcsw3</span></Typography>
                        <Typography align='center' sx={{fontSize:"16px",color:"#9e9e9e"}}>Order Amount : <span style={{color:"black"}}>450 Rs</span></Typography>
                        <Typography align='center' sx={{fontSize:"16px",color:"#9e9e9e"}}>Payment Method : <span style={{color:"black"}}>COD</span></Typography>
                        <Divider sx={{mt:"15px"}}/>
                    </Box>
                    <Box>
